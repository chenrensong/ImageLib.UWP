...
WebPBitmapFrame::WebPBitmapFrame()
{

}

WriteableBitmap^ WebPBitmapFrame::RenderFrame()
{
...
uint8_t* WebPBitmapFrame::GetPointerToPixelData(IBuffer^ pixelBuffer, unsigned int *length)
{
	if (length != nullptr)
	{
